...
* [App Architecture](#app-architecture)
  * [Dashboard Feed Project](#dashboard-feed-project)
  * [Dashboard Log Project](#dashboard-log-project)
  * [Dashboard App Project](#dashboard-app-project)
* [TDD and Clean Architecture](#tdd-and-clean-architecture)
* [App Features and Functionalities](#app-features-and-functionalities)
  * [Sync(Downloading data)](#syncdownloading-data)
  * [Custom Card view](#custom-card-view)
  * [Custom chart view](#custom-chart-view)
  * [Custom chart legend view](#custom-chart-legend-view)
  * [Navigation flow](#navigation-flow)
  * [Custom Navigation title](#custom-navigation-title)
  * [Individual list screen](#individual-list-screen)
  * [Job list row date calculation](#job-list-row-date-calculation)
  * [Alert for error](#alert-for-error)
  * [Custom toast view for status updates](#custom-toast-view-for-status-updates)
  * [Light/Dark mode](#lightdark-mode)
  * [Localization](#localization)
  * [Enabling/Disabling feature](#enablingdisabling-feature)
